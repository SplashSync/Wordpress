    ...
    */
    public function Get($id=NULL,$list=0)
    {
        ...
        if ( is_null($this->Object) )   {
            return Splash::Log()->Err("ErrLocalTpl",__CLASS__,__FUNCTION__," Unable to load Post (" . $id . ").");
        }
        //====================================================================//
        // Init Response Array 
    ...
    */    
    ...
    private function setInitObject($id) 
    {
        ...
        else
        {
            ...
            if ( is_null($this->Object) )   {
                return Splash::Log()->Err("ErrLocalTpl",__CLASS__,__FUNCTION__," Unable to create Post.");
            }   
        }        
